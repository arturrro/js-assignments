...
function getRectangleString(width, height) {
    ...
    //     //rysuj podsatawe i dolny bok
    //     if(h ==0 || h == height-1){
    //         result = result + repeatString("─",width) + "\n";
    //     }else{
    //         result = result + "|";
    //         result = result + repeatString(" ",width -2);
    //         result = result + "|\n";
    //     }
    //
    // }
...
function encodeToRot13(str) {
    ...
    function convertLetter(letter){
        ...
        var isUppercase = letter.toUpperCase() == letter;
        ...
        if(next > 122){
            result =  String.fromCharCode(96 + (next - 122));
        }else{
    ...
    for(var i = 0 ; i < str.length ; i++){
        result = result + convertLetter(str.charAt(i));
    }
    return result;
}
